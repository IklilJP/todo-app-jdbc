...
public class Jdbc {
    ...
    public static void add(String todo_name, String priority, String descripsion, String is_active) throws SQLException {
        Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);
    ...
    public static void update(String id, String todo_name, String priority, String descripsion, String is_active) throws SQLException {
        Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);
        Statement stmt = conn.createStatement();
    ...
    public static Boolean findbyId(String id) throws SQLException {
        Boolean found = false;
        Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery("SELECT * FROM todo WHERE id = '" + id + "'");
